      ...
      <section className="py-24">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex justify-center items-center flex-col gap-2">
            <span className="uppercase font-semibold text-gray-500" data-aos="fade-up">
              Announcements
            </span>
            <h3
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-16 mt-20">
            {/* News Card 1 */}
            <Card className="flex flex-col shadow-md hover:shadow-lg transition duration-300" data-aos="fade-up">
              <img
              ...
              <div className="p-4">
                ...
                <div className="flex items-center text-gray-500 mt-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 10h8m-4 4h4m-2 6H6a2 2 0 01-2-2V4a2 2 0 012-2h12a2 2 0 012 2v16a2 2 0 01-2 2H6z" />
                  </svg>
            ...
            {/* News Card 2 */}
            <Card className="flex flex-col shadow-md hover:shadow-lg transition duration-300" data-aos="fade-up" data-aos-delay="100">
              <img
            ...
            {/* News Card 3 */}
            <Card className="flex flex-col shadow-md hover:shadow-lg transition duration-300" data-aos="fade-up" data-aos-delay="200">
              <img
